...
from schedule import ProcessorsAvailability, modified_critical_path
...
def lambda_handler(event: dict[str, Any], context: Any) -> dict[str, Any]:
    ...
    try:
        ...
        mem_lim = event["mem_lim"]
        processors: ProcessorsAvailability = MappingProxyType(event["processors"])
        ...
        schedule, _, tasks_order, ub = modified_critical_path(G, processors, mem_lim, data)
